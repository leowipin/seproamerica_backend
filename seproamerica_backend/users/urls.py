...
urlpatterns = [
    ...
    path('clientNames/', ClientNamesView.as_view(), name='clientnames'),
    path('phoneEmail/', PhoneEmailView.as_view(), name='phoneemail'),
    ...
    path('phoneAccountSignin/', PhoneAccountSignInView.as_view(), name='operationalsignin'),
